...
const App: React.FC = () => {
  ...
  function images_location(Parent: string, Children: string) {
    ...
    if (parent) const children = getChildElement(parent, Children); //通过一个封装函数来获取上述获取到的元素的所有符合条件的子元素，获得一个数组
  ...
  function getChildElement(Parent: HTMLElement, Children: number) {
    var childrenArr = [];
