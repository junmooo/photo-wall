...
const Demo2 = () => {
  ...
  const onScroll = () => {
    console.log(
      document.getElementById("hello-0")?.getBoundingClientRect().y,
      document.getElementById("hello-1")?.getBoundingClientRect().y,
      document.getElementById("hello-2")?.getBoundingClientRect().y,
      document.getElementById("hello-3")?.getBoundingClientRect().y
    );
  };
  console.log("111");
